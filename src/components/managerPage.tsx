...
import type { ManagerOption } from '../App';
...
interface ManagerPageProps {
  onSelectOption: (option: Exclude<ManagerOption, null>) => void;
}

    
const ManagerPage: React.FC<ManagerPageProps> = ({ onSelectOption }) => {
    ...
    <div className="home-container">
      <div className="home-box">
        ...
        <div className="home-content">
          <button
            onClick={() => onSelectOption('generateReport')}
            className="manager-button"
          >
            Generate Report
          </button><br/>
          <button
            onClick={() => onSelectOption('orderHistory')}
            className="manager-button"
          >
            Order History
          </button><br/>
          <button
            onClick={() => onSelectOption('employees')}
            className="manager-button"
          >
            Employees
          </button>
          <br/>
          <button
            onClick={() => onSelectOption('inventory')}
            className="manager-button"
          >
            Inventory
          </button>
          <br/>
          <button
            onClick={() => onSelectOption('happyHour')}
            className="manager-button"
          >
            Happy Hour
          </button>
